...
bool get_ver(std::string version){
    ...
    else
    {
        ...
        else
        {
            ...
            if(choice=='Y'){
                ...
                std::string installer="https://github.com/astrohr/MPCS/releases/download/v"+latest_ver+"/MPCS-"+latest_ver+"-win64.exe";
